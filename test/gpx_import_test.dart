...
<gpx version="1.1" creator="t" xmlns="http://www.topografix.com/GPX/1/1">
  ...
  test('imports metadata description and a standard track type', () async {
    final file = await writeGpx('''
<?xml version="1.0"?>
<gpx version="1.1" creator="t" xmlns="http://www.topografix.com/GPX/1/1">
  <metadata><name>Morning ride</name><desc>River path</desc></metadata>
  <trk><type>cycling</type><trkseg>
    ...
    expect(activity.description, 'River path');
    expect(activity.activityType, ActivityTypeEntity.bike);
  });
